...
var CSDLogger = (function () {
    function CSDLogger() {
    }
    CSDLogger.init = function (_db, _isDB) {
        this.isDB = _isDB;
        ...
        /* winston.loggers.add('logger', {
             console: _consoleOptions,
             file: _infoFileOption
         });*/
        winston.loggers.add('logger', {
            transports: [
    ...
    CSDLogger.log = function (message) {
        if (this.isDB) {
    ...
    CSDLogger.info = function (message) {
        if (this.isDB) {
    ...
    CSDLogger.error = function (message) {
        if (this.isDB) {
